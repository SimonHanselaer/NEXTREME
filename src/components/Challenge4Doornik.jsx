...
import DoornikImage from "../assets/img/Kortrijk.jpg";
...
const Challenge4Doornik = (props) => {
  ...
  function create() {
    //Load in City ------------------------------------------------------------------------------------------
    this.city = this.add.image(game.config.width / 2, 100, 'doornik').setScale(.06);
    ...
    return (
        <h1 className={stylesTypo.header1}>Doornik</h1>
    )
}
