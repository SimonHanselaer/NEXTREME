    ...
    <div className={styles.contentContainer}>
      ...
      <h1 className={stylesTypo.header1}>Taal</h1>
        <section>
            ...
            <button className={`${stylesUi.button3} ${stylesTypo.small} ${styles.chooseButton}`} onClick={() => handleSelect("FR")}><span>Francais</span></button>
            <button className={`${stylesUi.button3} ${stylesTypo.small} ${styles.chooseButton}`} onClick={() => handleSelect("ENG")}><span>English</span></button>
        </section>
